    ...
    namespace detailv10 {
        template <typename T, typename Allocator> struct sherwood_v10_entry {
            ...
            static EntryPointer *empty_pointer() {
                static EntryPointer result[3] = {
                    EntryPointer(nullptr) + ptrdiff_t(1), nullptr, nullptr
                };
                return result + 1;
            }
        };
        ...
        public:
            ...
            size_t bucket(const FindKey &key) const {
                return hash_policy.template index_for_hash<0>(
                ...
                if (is_full()) {
                    ...
                    try {
                        AllocatorTraits::construct(
                            *this, std::addressof(new_entry->value), std::forward<Args>(args)...
                        );
                    } catch (...) {
