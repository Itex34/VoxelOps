...
enum class InventoryActionType : uint8_t { Move = 0, Split = 1, Swap = 2, Drop = 3, Use = 4 };
...
class Inventory {
  public:
    ...
    bool applyAction(const InventoryAction &action, InventoryRejectReason &outReject,
