...
public:
    ...
    [[nodiscard]] bool isTreatMissingCollisionAsSolid() const noexcept {
        return m_treatMissingCollisionAsSolid;
    }
    ...
    Camera &getCameraMutable() noexcept {
        return camera;
    } // if you need to adjust it externally
    [[nodiscard]] float getStepUpVisualOffset() const noexcept {
