...
public:
    ...
    virtual void
    setExternalSceneTextures(unsigned int sceneColorTex, unsigned int sceneLinearDepthTex) = 0;
    virtual void clearExternalSceneTextures() = 0;
    virtual bool supportsExternalShadowMap() const noexcept = 0;
    virtual void
    setExternalShadowMap(unsigned int shadowDepthCompareTex, const glm::mat4 &shadowViewProj) = 0;
