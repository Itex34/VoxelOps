...
public:
    ...
    void init(const vk::raii::Device& device, uint32_t queueFamilyIndex, const vk::raii::Queue& queue);
    void cleanup();
    ...
    void submitImageUpload(StagingBuffer&& stagingBuffer, vk::Image image, uint32_t width, uint32_t height);
