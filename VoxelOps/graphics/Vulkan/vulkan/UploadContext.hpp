...
class UploadContext {
  public:
    ...
    void init(const vk::raii::Device &device, uint32_t queueFamilyIndex,
    ...
    StagingBuffer createStagingBuffer(const vk::raii::PhysicalDevice &physicalDevice,
    ...
    void submitImageUpload(StagingBuffer &&stagingBuffer, vk::Image image, uint32_t width,
                           uint32_t height);
    void submitImageUploadArray(StagingBuffer &&stagingBuffer, vk::Image image, uint32_t width,
