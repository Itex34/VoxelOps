...
TraceResult traceSceneNormalized(vec3 origin, vec3 directionNormalized, float maxDistance) {
    return traceSceneRtNormalized(origin, directionNormalized, maxDistance);
}
