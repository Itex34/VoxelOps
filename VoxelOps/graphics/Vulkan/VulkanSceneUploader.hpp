...
public:
    ...
    [[nodiscard]] bool empty() const noexcept {
        return m_chunkRenderCache.empty();
    }
    [[nodiscard]] size_t size() const noexcept {
        return m_chunkRenderCache.size();
    }
    [[nodiscard]] const VulkanChunkRenderCache &chunkRenderCache() const noexcept {
        return m_chunkRenderCache;
    }
    [[nodiscard]] const auto &chunkMeshes() const noexcept {
        return m_chunkRenderCache.getChunkMeshes();
    }

    [[nodiscard]] const VkTexture &atlasTexture() const noexcept {
        return m_atlasTexture;
    }
    [[nodiscard]] const VkModel *remotePlayerModel() const noexcept {
        return m_remotePlayerModel.get();
    }
